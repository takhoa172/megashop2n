...
export function PublicNavbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-secondary border-b border-white/10">
      <div className="max-w-container-max mx-auto px-margin-desktop py-base flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            ...
            <Link href="/login" className="text-on-secondary/80 hover:text-primary transition-colors">
              <span className="material-symbols-outlined">account_circle</span>
            </Link>
          )}
          <button
